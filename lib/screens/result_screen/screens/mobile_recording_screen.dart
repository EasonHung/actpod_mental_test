...
class MobileRecordingResultScreen extends ConsumerWidget {

  MobileRecordingResultScreen();
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: size.height,
              child: Image(
                image: AssetImage(isPhone? "assets/images/result2_mobile.png" : "assets/images/result2_web.png"), // Result image

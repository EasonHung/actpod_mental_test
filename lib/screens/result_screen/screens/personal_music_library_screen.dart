...
class PersonalMusicLibraryResultScreen extends ConsumerWidget {

  PersonalMusicLibraryResultScreen();
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: size.height,
              child: Image(
                image: AssetImage(isPhone? "assets/images/result7_mobile.png" : "assets/images/result7_web.png"), // Result image

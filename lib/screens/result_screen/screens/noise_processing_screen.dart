...
class NoiseProcessingResultScreen extends ConsumerWidget {

  NoiseProcessingResultScreen();
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: size.height,
              child: Image(
                image: AssetImage(isPhone? "assets/images/result4_mobile.png" : "assets/images/result4_web.png"), // Result image
